	...
	'components'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
				...
				'recensioni/film'=>'review/list', // @TODO create page with review list parametrized by type/vote/ecc
				'recensioni/film/<id:\d+>/<title:\w+>'=>'review/view',
				'recensioni/categorie'=>'tag/list', // @TODO create a page with tag list?
				'recensioni/categorie/<id:\d+>/<tag:\w+>'=>'tag/view', // @todo create page listing reviews tagged with a defined tag
